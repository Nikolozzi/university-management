        ...
        <div id="content">
            ...
            <table>
                ...
                <c:forEach var="tempStudent" items="${STUDENT_LIST}">
                    ...
                    <c:url var="tempLinkUpdate" value="StudentSubjectController">
                        <c:param name="command" value="LOAD_UPDATE" />
                        <c:param name="studentId" value="${tempStudent.id}" />
                    </c:url>

                    <c:url var="tempLinkRegister" value="StudentSubjectController">
                        <c:param name="command" value="LOAD_REGISTER" />
                        <c:param name="studentId" value="${tempStudent.id}" />
                    </c:url>

                    <c:url var="deleteLink" value="StudentSubjectController">
            ...
            <table class="subjectTable">
                ...
                <c:forEach var="tempSubject" items="${SUBJECT_LIST}">
                    ...
                    <c:url var="deleteSubject" value="StudentSubjectController">
            ...
            <c:url var="tempStudSubj" value="StudentSubjectController">
